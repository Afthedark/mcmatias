/**
 * Categorías Productos Page Logic
 * Manages categories of type 'producto'
 */
...
async function loadCategorias(page = null) {
    ...
    try {
        let url = `/categorias/?tipo=producto&page=${currentPage}`;
        if (searchQuery) {
...
function openModal() {
    ...
    document.getElementById('modalTitle').textContent = 'Nueva Categoría de Producto';
...
async function openEditModal(id) {
    try {
        ...
        document.getElementById('modalTitle').textContent = 'Editar Categoría de Producto';
